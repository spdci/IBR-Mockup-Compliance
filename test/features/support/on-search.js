...
Given(/^SP has previously sent a search request to IBR$/, function () {
  speconSearch = spec(); // Initialize the specSearch object
});

When(/^IBR completes processing and calls SP on-search callback$/, async function () {
  try {
...
Then(/^SP should receive the on-search response from IBR$/, async function () {
