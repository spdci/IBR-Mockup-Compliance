@method=POST @endpoint=ibr/sync/search
Feature: Search person from IBR based on specific criteria

This API is to be exposed by the IBR.
It will be called by the SP systems or other registries.

    @smoke
    Scenario: Successfully search IBR to be processed
        Given System wants to sync search for person in IBR
    ...
    Scenario: Validate the structure of reg_records in search response Functional Test
        Given System has sent a sync search request for IBR person for a functional test
